...
setwd("/banach1/rq25/sci-fate_analysis/data/")

data_S <- readRDS("/banach1/rq25/sci-fate_analysis/data/data_S_scifate_CC_GR.rds")
#DimPlot(data_S, group.by = "treatment_time", dims = c(1,2), reduction = "umap.orig")
...
dir.path <- "/banach1/rq25/tmp/sci-fate_example2/"
dir.create(dir.path)
